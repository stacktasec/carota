...
function networkUp() {
  ...
  IMAGE_TAG=$IMAGETAG COUCHDB_TAG=$COUCHDBTAG docker-compose -f $COMPOSE_FILE -f $COMPOSE_FILE_RAFT2 -f $COMPOSE_FILE_COUCH -f $COMPOSE_FILE_CA up -d 2>&1
  docker ps -a

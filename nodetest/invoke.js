...
async function main() {
    try {
        ...
        await gateway.connect(connectionProfile, { wallet, identity: 'user5', discovery: { enabled: true } });
        ...
        await contract.submitTransaction('registerUser', 'ZZZZZZZZZZZRRRRRRRRRRRRR');
